    ...
    <div class="container">
        <div class="row">
          <div class ="col-md-12">
              ...
              <h5 class="text-center text-primary">All Details</h5>
                ...
                <div class="card mt-2">
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-3">
                    <input type="text" class="form-control form-control-sm"
                           value="Mobile Number:" readonly>
                    </div>
                    <div class="form-group col-md-3">
                    <input type="text" class="form-control form-control-sm"
                           value="In Time:" readonly>
                    </div>
                    
                    </div>
                    <h6>Publish Date:2022-06-30</h6>
